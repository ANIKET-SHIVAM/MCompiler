...
# mark_description "-Ofast -std=c99 -fno-inline-functions -S -fsource-asm -o tsc_icc1.s";
	.file "tsc.c"
	.text
..TXTST0:
# -- Begin  main
...
### 			a[i+1] = a[i] + b[i];
        ...
        movss     127992+a(%rdx), %xmm0                         #351.13
        incl      %ecx                                          #350.3
        movss     127988+a(%rdx), %xmm1                         #351.13
        addss     127992+b(%rdx), %xmm0                         #351.20
        addss     127988+b(%rdx), %xmm1                         #351.20
        movss     %xmm0, 127996+a(%rdx)                         #351.4
        movss     %xmm1, 127992+a(%rdx)                         #351.4
        addq      $-8, %rdx                                     #350.3
        cmpl      $15999, %ecx                                  #350.3
        jb        ..B8.5        # Prob 99%                      #350.3
                                # LOE rdx rbx r12 r13 r14 r15 ecx ebp
..B8.6:                         # Preds ..B8.5
                                # Execution count [1.99e+05]
        movss     a(%rip), %xmm0                                #351.13
...
### 		dummy(a, b, c, d, e, aa, bb, cc, 0.);
	...
	.cfi_def_cfa_offset 40
        ...
        movl      $e, %r8d                                      #353.3
        movl      $aa, %r9d                                     #353.3
        addss     b(%rip), %xmm0                                #351.20
        movss     %xmm0, 4+a(%rip)                              #351.4
