...
float X[32000] __attribute__((aligned(16))) ;
float Y[32000] __attribute__((aligned(16))) ;
float Z[32000] __attribute__((aligned(16))) ;
float U[32000] __attribute__((aligned(16))) ;
float V[32000] __attribute__((aligned(16))) ;
//float* __restrict__ array;
float array[180 * 180] __attribute__((aligned(16))) ;
float x[32000] __attribute__((aligned(16))) ;
float temp;
int temp_int;
float a[32000] __attribute__((aligned(16))) ;
float b[32000] __attribute__((aligned(16))) ;
float c[32000] __attribute__((aligned(16))) ;
float d[32000] __attribute__((aligned(16))) ;
float e[32000] __attribute__((aligned(16))) ;
float aa[180][180] __attribute__((aligned(16))) ;
float bb[180][180] __attribute__((aligned(16))) ;
float cc[180][180] __attribute__((aligned(16))) ;
float tt[180][180] __attribute__((aligned(16))) ;
int indx[32000] __attribute__((aligned(16))) ;
float * __restrict__ xx;
float *yy;
int dummy(float [32000],float [32000],float [32000],float [32000],float [32000],float [180][180],float [180][180],float [180][180],float );
...
int set2d(float arr[180][180],float value,int stride)
{
...
{
  xx = ((float *)(memalign(16,32000 * sizeof(float ))));
  printf("\n");
...
void OUT_1_tsc_324(void **__out_argv);
...
//	2. closed form solution: q = factor**n
  ...
  for (int nl = 0; nl < 2 * 200000; nl++) {
    ...
    __out_argv1__1527__[0] = ((void *)(&q));
    OUT_1_tsc_324p = findFunctionUsingDlopen("OUT_1_tsc_324","/tmp/OUT_1_tsc_324.so");
    ( *OUT_1_tsc_324p)(__out_argv1__1527__);
...
int main()
{
  ...
  int n1 = 1;
  int n3 = 1;
  int *ip = (int *)(memalign(16,32000 * sizeof(float )));
  float s1;
  float s2;
  set(ip,&s1,&s2);
