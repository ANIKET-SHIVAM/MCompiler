...
typedef enum{ EXTRACT, PROFILE, SYNTHESIZE, TEST, PARALLEL, AUTO_PARALLEL, PREFETCH, COMPILE_TO_OBJECT,
			  PROFILE_COUNT, INPUT_PROFILE, ADV_PROFILE, OUTPUT_BINARY, OUTPUT_OBJECT, KNL,
