...
OBJ_ENERGY_PROFILER = $(OBJS)/energy_profiler.o
SRC_ENERGY_PROFILER = $(PROFILER_PATH)/energy_profiler.cpp

profiler: $(OBJ_PROFILER) $(OBJ_ADV_PROFILER) $(OBJ_ENERGY_PROFILER)
...
$(OBJ_ENERGY_PROFILER): $(SRC_ENERGY_PROFILER)
	$(CC) $(FLAGS) $(PROFILER_COMPILE_FLAGS) $(SRC_ENERGY_PROFILER) -c -o $@
...
just_energy_profiler: $(SRC_ENERGY_PROFILER)
	rm -f $(OBJ_ENERGY_PROFILER)
	$(CC) $(FLAGS) $(PROFILER_COMPILE_FLAGS) $(SRC_ENERGY_PROFILER) -c -o $(OBJ_ENERGY_PROFILER)
	$(CC) $(OBJ_DRIVER) $(OBJ_EXTRACTOR) $(OBJ_PROFILER) $(OBJ_ENERGY_PROFILER) $(OBJ_SYNTHESIZER) $(OBJ_COMMON) $(DRIVER_LD_FLAGS) -o $(BIN)/MCompiler
...
driver: $(OBJ_DRIVER) $(OBJ_EXTRACTOR) $(OBJ_PROFILER) $(OBJ_ADV_PROFILER) $(OBJ_ENERGY_PROFILER) $(OBJ_PREDICTOR) $(OBJ_SYNTHESIZER) $(OBJ_COMMON) $(OBJ_TESTER)
	$(CC) $^ $(DRIVER_LD_FLAGS) -o $(BIN)/MCompiler
$(OBJ_DRIVER): $(SRC_DRIVER)
	$(CC) $(FLAGS) $(DRIVER_COMPILE_FLAGS) $(SRC_DRIVER) -c -o $@

just_driver: $(OBJ_EXTRACTOR) $(OBJ_PROFILER) $(OBJ_ADV_PROFILER) $(OBJ_ENERGY_PROFILER) $(OBJ_PREDICTOR) $(OBJ_SYNTHESIZER) $(OBJ_COMMON) $(OBJ_TESTER)
	rm -f $(OBJ_DRIVER)
